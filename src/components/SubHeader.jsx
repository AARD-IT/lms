    ...
    <div className="sub-header">
      <div className="container">
        <div className="row">
            ...
            <div className="sub-header-left">
              <ul className="d-flex drop-area">
                ...
                <li className="drop-area">
                  <a href="#">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M9.99453 11.1912C11.4305 11.1912 12.5945 10.0272 12.5945 8.59121C12.5945 7.15527 11.4305 5.99121 9.99453 5.99121C8.55859 5.99121 7.39453 7.15527 7.39453 8.59121C7.39453 10.0272 8.55859 11.1912 9.99453 11.1912Z" stroke="#192335" strokeWidth="1.25" />
                      <path d="M3.0187 7.0763C4.66037 -0.140363 15.352 -0.132029 16.9854 7.08464C17.9437 11.318 15.3104 14.9013 13.002 17.118C11.327 18.7346 8.67704 18.7346 6.9937 17.118C4.6937 14.9013 2.06037 11.3096 3.0187 7.0763Z" stroke="#192335" strokeWidth="1.25" />
                    </svg>
                    Delhi
                  </a>
                </li>
          ...
          <div className="col-lg-6 col-md-6">
            <div className="sub-header-left right-sub">
              <ul className="d-flex drop-area">
                <li className="primary-end">
                  <form action="https://analyticsavenue.in/select/language" method="get">
                    <select name="language" id="lng-selector" className="form-select nice-control">
                      <option value="English" defaultValue>English</option>
                    </select>
                  </form>
                </li>
                <li className="drop-area"><a href="https://twitter.com"><i className="fa-brands fa-x-twitter"></i></a></li>
                <li className="drop-area"><a href="https://linkedin.com"><i className="fa-brands fa-linkedin"></i></a></li>
                <li className="drop-area"><a href="https://facebook.com"><i className="fa-brands fa-square-facebook"></i></a></li>
              </ul>
            </div>
          </div>
        </div>
