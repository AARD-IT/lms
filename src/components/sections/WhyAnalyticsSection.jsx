            ...
            <div className="col-md-7">
              <div className="thewhyanayticslefts">
                ...
                <div className="thewhyanayicssinfosleft">
                  ...
                  <p><span className="thepiticon"><img src="public/assets/frontend/default/images/img/pwefectpoints.png" alt="" /></span>A perfect platform for career transition seekers, freshers and passionate data experts</p>
                </div>
              </div>
            </div>
            <div className="col-md-5">
              <div className="thewhyanayticsrights" style={{ height: 'auto' }}>
                <div className="the-video-card" style={{ height: 'auto' }}>
                  <img src="public/assets/about/image.png" alt="" className="thebigaboutimage" style={{ height: 'auto', objectFit: 'contain' }} />
                  <button className="play-wave" id="playBtn" type="button">
                    <img src="public/assets/frontend/default/images/img/aboutrowplay.png" alt="" className="theaboutrowplays" />
                  </button>
